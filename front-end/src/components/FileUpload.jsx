  ...
  return (
    <div className='flex flex-col m-2 p-4'>
      <h1
        ...
        style={{ color: { color: getFontColorSecondary(isDarkTheme) } }}
      >
        Upload File
      </h1>
      <div className='mb-6 text-gray-600' style={{ color: { color: getFontColorSecondary(isDarkTheme) } }}>
      ...
      <form onSubmit={submitFile} className='flex'>
        ...
        <Button
          ...
          style={getBgPrimary(isDarkTheme)}
        />
      </form>
    </div>
  );
